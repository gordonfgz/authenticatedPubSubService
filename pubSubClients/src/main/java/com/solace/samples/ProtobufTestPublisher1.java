 ...
 *
 */
public class ProtobufTestPublisher1 {
	
	static boolean isShutdown = false;
    
    public void run(String... args) throws IOException {
        System.out.println("ProtobufTestPublisher1 initializing...");
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length < 2) {
            System.out.println("Usage: ProtobufTestPublisher1 tcp://<host:port> [id_token] [access_token]");
            System.out.println();
            System.exit(-1);
        }
        new ProtobufTestPublisher1().run(args);
    }
}
