 ...
 *
 */
public class RedhatProdSubscriber {
    ...
    public void run(String... args) throws IOException {
        System.out.println("RedhatProdSubscriber initializing...");
        ...
        try {
            ...
            String password = "OPENID~RedhatKeyCloakDev~" + idToken + "~" + accessToken;
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length != 1) {
            System.out.println("Usage: RedhatProdSubscriber <mqtt-host-name>");
            System.out.println();
            System.exit(-1);
        }
        new RedhatProdSubscriber().run(args);
    }
}
