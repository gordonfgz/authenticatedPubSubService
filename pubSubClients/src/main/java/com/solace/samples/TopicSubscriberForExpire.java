 ...
 *
 */
public class TopicSubscriberForExpire {
    ...
    public void run(String... args) throws IOException {
        System.out.println("TopicSubscriberForExpire initializing...");
        ...
        try {
            ...
            final String subTopic = "solace/expire";
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length < 2) {
            System.out.println("Usage: TopicSubscriberForExpire tcp://<host:port> <client-username> [client-password]");
            System.out.println();
            System.exit(-1);
        }
        new TopicSubscriberForExpire().run(args);
    }
}
